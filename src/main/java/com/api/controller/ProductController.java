...
public class ProductController {
    ...
    public ResponseEntity<?> getAll(@RequestParam(name = "pag") String pag) {
        ...
        final List<EntityModel<SimpleProduct>> content = makeMapping(productPage.getContent());
        PagedEntity<EntityModel<SimpleProduct>> pagedModel = new PagedEntity<>(productPage, content);
